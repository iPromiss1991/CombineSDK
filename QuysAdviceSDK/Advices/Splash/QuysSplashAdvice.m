...
- (void)config
{
    ...
    QuysQYXSplashAdvice *service = [[QuysQYXSplashAdvice alloc] initWithID:self.businessID key:self.bussinessKey cgRect:self.cgFrame eventDelegate:self parentView:self.parentView];
    self.advice = service;
